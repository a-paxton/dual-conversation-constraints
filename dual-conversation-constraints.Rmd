...
```{r plot-standardized-residuals, eval=FALSE, echo=FALSE}
...
rio_residuals = qplot(x = fitted(rec_convers_condition_gca_st_rio), 
  ...
  scale_color_viridis() +
  coord_cartesian(xlim = c(-3,3), ylim = c(-2,3)) +
...
max_residuals = qplot(x = fitted(rec_convers_condition_gca_st), 
  ...
  geom_hline(aes(yintercept=0)) + geom_smooth() + coord_cartesian(xlim = c(-3,3), ylim = c(-2,3)) +
...
```{r hist-standardized-residuals, eval=FALSE, echo=FALSE}
...
rio_residuals = qplot(resid(rec_convers_condition_gca_st_rio),
  ...
  coord_cartesian(xlim = c(-2,2), ylim = c(0,y_max)) + 
