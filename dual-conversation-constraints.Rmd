---
title: "High- and Low-Level Constraints on Coordination during Conversation: Data Analysis for Paxton & Dale (in preparation)"
...
dual_task_data = condition_dfs[[1]]
noise_data = condition_dfs[[2]]
...
ggsave('./figures/DCC-interaction-RR_lag_conversation_condition.png',
       ...
       grid.arrange(
         top=textGrob("Head movement coordination\nby task and conversation",
                      gp=gpar(fontsize=14)),
         dual_task_plot,
         noise_plot,
